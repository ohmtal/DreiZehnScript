// NOTE: modified version by XXTH 2026-09-26
#ifndef FENSTER_H
#define FENSTER_H
...
FENSTER_API int fenster_open(struct fenster *f) {
  ...
  // NOTE: XXTH START >>>>>>>
  wmDeleteMessage = XInternAtom(f->dpy, "WM_DELETE_WINDOW", False);
  XSetWMProtocols(f->dpy, f->w, &wmDeleteMessage, 1);
  // <<<<<< XXTH
